...
export default function WireFrameHomeSection() {
    return (
        <section id="home" className="flex flex-col mt-[52px] h-[calc(100vh-52px)]">
            <div id="top" className="flex h-[90%]">
                ...
                <div id="right" className="flex flex-col items-start justify-center p-2">
                    <Card>
                        <CardHeader>
                        ...
                        <CardContent>
                        <FeaturedProjectImageLoader src={`/projects/${Projects[0].imageFile}`} alt={Projects[0].title}/>
                        </CardContent>
                    </Card>
            ...
            <div id="bottom" className="grow flex flex-col items-center">
                <TypographyH2 className="text-blue-500">Skills & Tools</TypographyH2>
