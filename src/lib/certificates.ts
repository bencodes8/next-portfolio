...
export const certificates: Certificate[] = [
    ...
    },
    {
      ...
      description: 'Course provided foundation using SQL to create, read, update, and delete relational databases. Also learned how to model real-world entities, normalize data, and understand trade-offs when indexing tables within databases.',
      year_received: 2023
    }
];